...
CREATE TABLE LEARNING_TYPE (
	LEARNING_TYPE_ID VARCHAR(20) NOT NULL,
	DESCRIPTION VARCHAR(80),
	CREATED_TS TIMESTAMP NOT NULL,
	LAST_UPDATED_TS TIMESTAMP,
	CONSTRAINT PK_cs PRIMARY KEY (LEARNING_TYPE_ID)
);
...
CREATE TABLE LEARNING_DATA (
	...
	CREATED_TS TIMESTAMP NOT NULL,
	LAST_UPDATED_TS TIMESTAMP,
	CONSTRAINT PK_cs PRIMARY KEY (LEARNING_ID),
	CONSTRAINT FK_ld_ldt
     FOREIGN KEY (LEARNING_TYPE_ID)
     REFERENCES LEARNING_TYPE(LEARNING_TYPE_ID),
    CONSTRAINT FK_ld_c
