package org.social.filter.classifier.bayes;
...
public class ClassifierTest {
    ...
    public void testClassifier() throws Exception {
        ...
        assertEquals("positive", bayes.classify(Arrays.asList(unknownText1)).getCategory());
        assertEquals("negative", bayes.classify(Arrays.asList(unknownText2)).getCategory());
